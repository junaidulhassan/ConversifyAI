...
st.markdown('<div style="text-align: center;"><h1>FITNESS RAT</h1></div>', unsafe_allow_html=True)
st.markdown('<div style="text-align: center;">Your First AI Fitness Coach! 😊</div>', unsafe_allow_html=True)
